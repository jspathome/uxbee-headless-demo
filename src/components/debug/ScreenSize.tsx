export default function SrceenSize() {
  return (
    <div className="fixed bottom-0 right-0 p-6 w-8 bg-red-100 font-bold border flex justify-center items-center opacity-75">
